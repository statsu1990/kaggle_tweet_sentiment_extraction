...
class Model_v1_22_0():
    """
    fork Model_v1_21_0
    cv 0.558379 (only posi and nega), 0.560521 with postproc_selected_text_v14
    apply postproc_selected_text_v14 to selected_text for preproc
...
class Model_v1_22_1():
    """
    fork Model_v1_21_0
    cv 0.559548 (only posi and nega), 0.560520 with postproc_selected_text_v14
    apply postproc_selected_text_v14 to selected_text for preproc
    warmup = 1

    save best score checkpoint (with postproc_selected_text_v14)
    weight decay (hidden(LN, bias)=0.0, hidden(other)=0.01, head=0.0001)
    multi linear head (hidden=[128], dropout=0.1)
    dropout=0.1
    Learnable weight of averaging hidden layer, n_hid=12, average, learn=False
...
class Model_v1_22_2():
    """
    fork Model_v1_21_0
    cv 0.557792 (only posi and nega), 0.560074 with postproc_selected_text_v14
    [NO USE]apply postproc_selected_text_v14 to selected_text for preproc
    warmup = 1
...
class Model_v1_22_3():
    """
    fork Model_v1_21_0
    cv 0.555856 (only posi and nega), 0.558833 with postproc_selected_text_v14
    warmup = 0
