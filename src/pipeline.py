...
class Model_v1_16_0():
    """
    cv 0.546599 (only posi and nega), lb 
    XLNetQAHead(n_top=3)
...
class Model_v1_16_2():
    """
    cv 0.550632 (only posi and nega), lb 
    XLNetQAHead2(n_top=3)
    ...
    def get_model(self):
        ...
        START_TOP_N = 3
        ans_idx_head = tweet_model.XLNetQAHead2(768, START_TOP_N)
...
class Model_v1_16_3():
    """
    cv 0.545782 (only posi and nega), lb 
...
class Model_v1_16_4():
    """
    cv 0.544662 (only posi and nega), lb 
    XLNetQAHead3(n_top=3)
    ...
    def get_model(self):
        ...
        START_TOP_N = 3
        ans_idx_head = tweet_model.XLNetQAHead3(768, START_TOP_N)
...
class Model_v1_16_5():
    """
    cv 0.550960 (only posi and nega), lb 
...
class Model_v1_16_6():
    """
    cv 0.545139 (only posi and nega), lb 
    XLNetQAHead(n_top=10)
...
class Model_v1_16_7():
    """
    cv 0.548332 (only posi and nega), lb 
    XLNetQAHead2(n_top=10)
...
class Model_v1_16_8():
    """
    cv 0.550018 (only posi and nega), lb 
    XLNetQAHead3(n_top=10)
