...
class Model_v1_17_0():
    """
    cv 0.550804 (only posi and nega), lb 
...
class Model_v1_17_1():
    """
    cv 0.548205 (only posi and nega), lb 
...
class Model_v1_17_2():
    """
    cv 0.551376 (only posi and nega), lb 
...
class Model_v1_17_4():
    """
    cv 0.548902 (only posi and nega), lb 
...
class Model_v1_17_5():
    ...
    XLNetQAHead(n_top=5)
    Learnable weight of averaging hidden layer, n_hid=3, max, learn=True
    """
    def __init__(self):
        self.set_config()
        return
