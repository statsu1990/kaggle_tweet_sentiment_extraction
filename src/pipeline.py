...
class Model_v1_20_1():
    """
    cv 0.549920 (only posi and nega), lb 
    XLNetQAHead2(n_top=5)
    ...
    def get_model(self):
        ...
        N_TOP = 5
        ans_idx_head = tweet_model.XLNetQAHead2(768, N_TOP)
...
class Model_v1_20_2():
    """
    cv 0.549871 (only posi and nega), lb 
    XLNetQAHead3(n_top=5)
    ...
    def get_model(self):
        ...
        N_TOP = 5
        ans_idx_head = tweet_model.XLNetQAHead3(768, N_TOP)
