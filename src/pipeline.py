...
class Model_v1_10_0():
    """
    score 0.520439 (only posi and nega), 
    JaccardExpectationLoss
    ...
    def train(self, only_val=False):
        ...
        EPOCHS = 20 if not ONLY_VAL else 1
        BATCH_SIZE = 32
        WARMUP_EPOCHS = 0
        GRAD_ACCUM_STEP = 1
        LR = 1e-5
...
class Model_v1_10_1():
    """
    score 0.547114 (only posi and nega), 
    JaccardExpectationLoss * 1.0 + IndexLoss * 0.2
...
class Model_v1_10_3():
    """
    score 0.546657 (only posi and nega), 
    JaccardExpectationLoss * 1.0 + IndexLoss * 1.0
