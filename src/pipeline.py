...
class Model_v1_18_0():
    """
    cv 0.54893 (only posi and nega), lb 
    weight decay (hidden(LN, bias)=0.0, hidden(other)=0.01, head=0.01)
...
class Model_v1_18_2():
    """
    cv 0.553674 (only posi and nega), lb 
    weight decay (hidden(LN, bias)=0.0, hidden(other)=0.01, head=0.00001)
        ...
        for fold, (train_idx, val_idx) in enumerate(skf.split(train_df, train_df.sentiment)):
            if fold < NUM_FOLD:
                ...
                params = [
                    ...
                    {'params': bert_params, 'lr': LR, 'weight_decay':0.01},
                    {'params': bert_params_sep, 'lr': LR, 'weight_decay':0.0},
                    {'params': other_params, 'lr': LR * DIF_LR_RATE, 'weight_decay':0.00001}
                    ]
                optimizer = optim.AdamW(params, betas=(0.9, 0.999))
...
class Model_v1_18_3():
    """
    cv 0.549853 (only posi and nega), lb 
    weight decay (hidden(LN, bias)=0.0, hidden(other)=0.001, head=0.0001)
    ...
    def train(self, only_val=False):
        ...
        for fold, (train_idx, val_idx) in enumerate(skf.split(train_df, train_df.sentiment)):
            if fold < NUM_FOLD:
                ...
                params = [
                    #{'params': bert_params, 'lr': LR, 'weight_decay':0.01},
                    {'params': bert_params, 'lr': LR, 'weight_decay':0.001},
                    {'params': bert_params_sep, 'lr': LR, 'weight_decay':0.0},
                    {'params': other_params, 'lr': LR * DIF_LR_RATE, 'weight_decay':0.0001}
                    ]
                optimizer = optim.AdamW(params, betas=(0.9, 0.999))
...
class Model_v1_18_4():
    """
    cv 0.548809 (only posi and nega), lb 
    weight decay (hidden(LN, bias)=0.0, hidden(other)=0.01, head=0.001)
        ...
        for fold, (train_idx, val_idx) in enumerate(skf.split(train_df, train_df.sentiment)):
            if fold < NUM_FOLD:
                ...
                params = [
                    ...
                    {'params': bert_params, 'lr': LR, 'weight_decay':0.01},
                    {'params': bert_params_sep, 'lr': LR, 'weight_decay':0.0},
                    {'params': other_params, 'lr': LR * DIF_LR_RATE, 'weight_decay':0.001}
                    ]
                optimizer = optim.AdamW(params, betas=(0.9, 0.999))
...
class Model_v1_18_5():
    """
    cv 0.0.552835 (only posi and nega), lb 
    weight decay (hidden(LN, bias)=0.0, hidden(other)=0.1, head=0.0001)
    ...
    def train(self, only_val=False):
        ...
        for fold, (train_idx, val_idx) in enumerate(skf.split(train_df, train_df.sentiment)):
            if fold < NUM_FOLD:
                ...
                params = [
                    #{'params': bert_params, 'lr': LR, 'weight_decay':0.01},
                    {'params': bert_params, 'lr': LR, 'weight_decay':0.1},
                    {'params': bert_params_sep, 'lr': LR, 'weight_decay':0.0},
                    {'params': other_params, 'lr': LR * DIF_LR_RATE, 'weight_decay':0.0001}
                    ]
                optimizer = optim.AdamW(params, betas=(0.9, 0.999))
