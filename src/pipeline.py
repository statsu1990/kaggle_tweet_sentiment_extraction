...
class Model_v1_13_0():
    """
    score 0.724438, lb 
    (ep5 cv0.724438, ep3 cv0.7274)
    augmentation add_neutral = 0.0
...
class Model_v1_13_5():
    ...
    score 0.544308, lb 
    (ep5 cv, ep3 cv)
    augmentation add_neutral = 0.0, ADD_NONSENTIMENT_P=0.5
...
class Model_v1_13_6():
    ...
    score 0.544288, lb 
    (ep5 cv, ep3 cv)
    augmentation add_neutral = 0.0, ADD_NONSENTIMENT_P=1.0
...
class Model_v1_13_5_1():
    """
    score 0.54288100, lb 
    (ep5 cv, ep3 cv)
    augmentation add_neutral = 0.0, ADD_NONSENTIMENT_P=0.0(0.5のつもりだった)
...
class Model_v1_13_6_1():
    """
    score 0., lb 
    (ep5 cv, ep3 cv)
    augmentation add_neutral = 0.0, ADD_NONSENTIMENT_P=0.0(1.0のつもりだった)
...
class Model_v1_13_7():
    ...
    score 0.550780, lb 
    (ep5 cv, ep3 cv)
    augmentation add_neutral = 0.5, ADD_NONSENTIMENT_P=0.5
...
class Model_v1_13_8():
    ...
    score 0.546118, lb 
    (ep5 cv, ep3 cv)
    augmentation add_neutral = 0.3, ADD_NONSENTIMENT_P=0.3
    ...
    def set_config(self):
        ...
        # data
        self.TRAIN_ONLY_POSI_NEGA = True
        self.ADD_NEUTRAL_P = 0.3
        self.ADD_NONSENTIMENT_P = 0.3
...
class Model_v1_13_9():
    ...
    score 0.550378, lb 
    (ep5 cv, ep3 cv)
    augmentation add_neutral = 0.0, ADD_NONSENTIMENT_P=0.0
    ADD_DIFFERENT_SENTIMENT_P=0.5
    ...
    def set_config(self):
        ...
        self.ADD_DIFFERENT_SENTIMENT_P = 0.5
...
class Model_v1_13_10():
    """
    score , lb 
    (ep5 cv, ep3 cv)
    augmentation add_neutral = 0.0, ADD_NONSENTIMENT_P=0.0
    ADD_DIFFERENT_SENTIMENT_P=1.0
    ...
    def set_config(self):
        ...
        self.ADD_NEUTRAL_P = 0.0
        self.ADD_NONSENTIMENT_P = 0.0
        self.ADD_DIFFERENT_SENTIMENT_P = 1.0
...
class Model_v1_13_11():
    """
    score , lb 
    (ep5 cv, ep3 cv)
    exchange_selected_text_p = 0.5
    ...
    def set_config(self):
        ...
        self.EXCHANGE_SELECTED_TEXT_P = 0.5
...
class Model_v1_13_12():
    """
    score 0.537320, lb 
    (ep5 cv, ep3 cv)
    ADD_DIFFERENT_SENTIMENT_P = 0.5
    exchange_selected_text_p = 0.3
    ...
    def set_config(self):
        ...
        self.ADD_NONSENTIMENT_P = 0.0
        self.ADD_DIFFERENT_SENTIMENT_P = 0.5
        self.EXCHANGE_SELECTED_TEXT_P = 0.3
...
class Model_v1_13_13():
    """
    score 0.534010, lb 
    (ep5 cv, ep3 cv)
    insert_selected_text_p = 0.5
    ...
    def set_config(self):
        ...
        self.INSERT_SELECTED_TEXT_P = 0.5
